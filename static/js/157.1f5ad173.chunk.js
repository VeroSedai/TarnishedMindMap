"use strict";(self.webpackChunkreact_elden_ring_mind_map=self.webpackChunkreact_elden_ring_mind_map||[]).push([[157],{5555:(t,e,r)=>{r.d(e,{D:()=>c});var s=r(3999),o=r(4994);(0,o.y)(),(0,o.y)(),(0,o.y)();var i=s.C`
  * {
...
`,c=t=>{var e;class r extends t{constructor(){super(...arguments),this.unsubscribeFrom=[],this.useStore=o.l.bind(this)}connectedCallback(){setTimeout((()=>{var t,e;let r=document.getElementById("superviz-style"),s=this.createCustomColors(),o=document.createElement("style");o.innerHTML=(null==r?void 0:r.innerHTML)||"",null==(t=this.shadowRoot)||t.appendChild(o),s&&(null==(e=this.shadowRoot)||e.appendChild(s))})),super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeFrom.forEach((t=>t(this)))}createCustomColors(){if(!o.f.get("colors"))return;let t=document.createElement("style"),e=Object.entries(o.f.get("colors")).map((t=>{let[e,r]=t;return`--${e}: ${r} !important;`})).join(" ");return t.innerHTML=`\n      * {\n        ${e}\n      }\n    `,t}emitEvent(t,e){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{composed:!0,bubbles:!0},s=new CustomEvent(t,(0,o.A)({detail:e},r));this.dispatchEvent(s)}}return r.styles=[i,n,a,l,null!=(e=t.styles)?e:[]],r}},9157:(t,e,r)=>{r.r(e),r.d(e,{Icon:()=>g});var s=r(5555),o=r(3999),i=r(4994);(0,i.y)(),(0,i.y)();var n,a=((n=a||{})[n.xs=14]="xs",n[n.sm=18]="sm",n[n.md=24]="md",n[n.lg=36]="lg",n[n.xl=44]="xl",n),l=(0,s.D)(o.a),c=[l.styles],g=class extends l{constructor(){super(),this.name="",this.size="md"}get iconSize(){return a[this.size]}render(){var t;return this.color||(this.color="black"),o.V`
      <i
        class="sv-icon sv-icon-${this.name}_${null!=(t=this.suffix)?t:this.size} ${this.color}"
        style="font-size: ${this.iconSize}px"
      ></i>
    `}};g.properties={name:{type:String},size:{type:String},color:{type:String},suffix:{type:String}},g.styles=[c,o.C`
      div {
        position: absolute;
        top: 0;
        left: 0;
    ...
    `],g=(0,i.e)([(0,o.t)("superviz-icon")],g)}}]);
//# sourceMappingURL=157.1f5ad173.chunk.js.map